...
use yaxpeax_x86::protected_mode::{DisplayRules, DisplayStyle};
use yaxpeax_x86::protected_mode::AbsoluteAddressFormatter;
...
fn test_absolute_addr() {
    ...
    static CASES: &'static [TestCase] = &[
        ...
        TestCase::new(
            ...
            "xor eax, dword [0x12345678]", Some("eax ^= [0x12345678]"), Some("xor eax, dword ptr [12345678h]"),
        ),
        TestCase::new(
            &[0xeb, 0x10],
...
fn test_symbolication() {
    ...
    static CASES: &'static [TestCase] = &[
        ...
        TestCase::new(
            ...
            "xor eax, dword [global]", Some("eax ^= [global]"), Some("xor eax, dword ptr [global]"),
        ),
        TestCase::new(
