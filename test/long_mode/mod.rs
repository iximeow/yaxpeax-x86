...
#[test]
fn test_aesni() {
//    ({ $($feature:ident $decode:expr)+ } $bytes:expr, $text:expr) => {
...
#[test]
fn test_sse2() {
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x0f, 0x10, 0x0c, 0xc7], "movsd xmm1, qword [rdi + rax * 8]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x0f, 0x11, 0x0c, 0xc7], "movsd qword [rdi + rax * 8], xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0x11, 0x0c, 0xc7], "movupd xmmword [rdi + rax * 8], xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x12, 0x03], "movlpd xmm8, qword [r11]"); // reg-mem is movlpd
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x13, 0x03], "movlpd qword [r11], xmm8");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x13, 0xc3]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x14, 0x03], "unpcklpd xmm8, xmmword [r11]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x14, 0xc3], "unpcklpd xmm8, xmm11");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x15, 0x03], "unpckhpd xmm8, xmmword [r11]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x15, 0xc3], "unpckhpd xmm8, xmm11");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x16, 0x03], "movhpd xmm8, qword [r11]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x17, 0x03], "movhpd qword [r11], xmm8");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x17, 0xc3]);

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x28, 0xd0], "movapd xmm10, xmm8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x28, 0x00], "movapd xmm8, xmmword [r8]");

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2a, 0xcf], "cvtpi2pd xmm9, mm7");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2a, 0x0f], "cvtpi2pd xmm9, qword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x2a, 0xcf], "cvtsi2sd xmm9, r15");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x2a, 0x0f], "cvtsi2sd xmm9, qword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2b, 0x0f], "movntpd xmmword [r15], xmm9");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2c, 0xcf], "cvttpd2pi mm1, xmm15");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2c, 0x0f], "cvttpd2pi mm1, xmmword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x2c, 0xcf], "cvttsd2si r9, xmm15");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x2c, 0x0f], "cvttsd2si r9, qword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x40, 0x0f, 0x2c, 0xcf], "cvttsd2si ecx, xmm7");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x40, 0x0f, 0x2c, 0x0f], "cvttsd2si ecx, qword [rdi]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2d, 0xcf], "cvtpd2pi mm1, xmm15");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2d, 0x0f], "cvtpd2pi mm1, xmmword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x2d, 0xcf], "cvtsd2si r9, xmm15");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x2d, 0x0f], "cvtsd2si r9, qword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x40, 0x0f, 0x2d, 0xcf], "cvtsd2si ecx, xmm7");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x40, 0x0f, 0x2d, 0x0f], "cvtsd2si ecx, qword [rdi]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2e, 0xcf], "ucomisd xmm9, xmm15");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2e, 0x0f], "ucomisd xmm9, qword [r15]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2f, 0xcf], "comisd xmm9, xmm15");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x2f, 0x0f], "comisd xmm9, qword [r15]");
    ...
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x50, 0xc1], "movmskpd r8d, xmm9");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x51, 0x01], "sqrtpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x51, 0x01], "sqrtsd xmm8, qword [r9]");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x52, 0x01]);
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x53, 0x01]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x54, 0x01], "andpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x55, 0x01], "andnpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x56, 0x01], "orpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x57, 0x01], "xorpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x58, 0x01], "addpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x58, 0x01], "addsd xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x59, 0x01], "mulpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x59, 0x01], "mulsd xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x5a, 0x01], "cvtpd2ps xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x5a, 0x01], "cvtsd2ss xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x5b, 0x01], "cvtps2dq xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x5c, 0x01], "subpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x5c, 0x01], "subsd xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x5d, 0x01], "minpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x5d, 0x01], "minsd xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x5e, 0x01], "divpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x5e, 0x01], "divsd xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x5f, 0x01], "maxpd xmm8, xmmword [r9]");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0x5f, 0x01], "maxsd xmm8, qword [r9]");
    testcase!(features { SSE: true, SSE2: true } 
    ...
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x48, 0x0f, 0x6e, 0xc0], "movq xmm0, rax");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0x70, 0xc0, 0x4e], "pshufd xmm0, xmm0, 0x4e");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x0f, 0x70, 0xc0, 0x4e], "pshuflw xmm0, xmm0, 0x4e");
    testcase!(features { SSE: true, SSE2: true } &[0xf3, 0x0f, 0x70, 0xc0, 0x4e], "pshufhw xmm0, xmm0, 0x4e");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x71, 0x10, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x71, 0xd0, 0x8f], "psrlw xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x71, 0x20, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x71, 0xe0, 0x8f], "psraw xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x71, 0x30, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x71, 0xf0, 0x8f], "psllw xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x72, 0x10, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x72, 0xd0, 0x8f], "psrld xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x72, 0x20, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x72, 0xe0, 0x8f], "psrad xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x72, 0x30, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x72, 0xf0, 0x8f], "pslld xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x73, 0x10, 0x8f]);
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x73, 0x18, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x73, 0xd0, 0x8f], "psrlq xmm8, 0x8f");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x73, 0xd8, 0x8f], "psrldq xmm8, 0x8f");
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x73, 0x30, 0x8f]);
    testcase!(invalid: &[0x66, 0x4f, 0x0f, 0x73, 0x38, 0x8f]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x73, 0xf0, 0x8f], "psllq xmm8, 0x8f");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x73, 0xf8, 0x8f], "pslldq xmm8, 0x8f");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0x7e, 0xc1], "movd ecx, xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x48, 0x0f, 0x7e, 0xc1], "movq rcx, xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x48, 0x0f, 0x7e, 0x01], "movq qword [rcx], xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0x7e, 0xc1], "movq r9, xmm8");
    testcase!(features { SSE: true, SSE2: true } 
        &[0x66, 0x4f, 0x0f, 0x7f, 0x9c, 0x9c, 0x34, 0xaa, 0xbb, 0xcc],
        "movdqa xmmword [r12 + r11 * 4 - 0x334455cc], xmm11"
    );

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc2, 0xc3, 0x08], "cmppd xmm0, xmm3, 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xc2, 0xc3, 0x08], "cmppd xmm8, xmm11, 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xc2, 0x03, 0x08], "cmppd xmm8, xmmword [r11], 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x0f, 0xc2, 0xc3, 0x08], "cmpsd xmm0, xmm3, 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0xc2, 0xc3, 0x08], "cmpsd xmm8, xmm11, 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0xc2, 0x03, 0x08], "cmpsd xmm8, qword [r11], 0x8");

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc4, 0xc3, 0x08], "pinsrw xmm0, ebx, 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xc4, 0xc3, 0x08], "pinsrw xmm8, r11d, 0x8");

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc4, 0x03, 0x08], "pinsrw xmm0, word [rbx], 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xc4, 0x03, 0x08], "pinsrw xmm8, word [r11], 0x8");

//    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc5, 0xc3, 0x08], "pextrw eax, xmm3, 0x8");
//    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xc5, 0xc3, 0x08], "pextrw r8d, xmm11, 0x8");
//    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc5, 0x03, 0x08]);
//    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc5, 0x40, 0x08]);
//    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc5, 0x80, 0x08]);

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xc6, 0x03, 0x08], "shufpd xmm8, xmmword [r11], 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc6, 0x03, 0x08], "shufpd xmm0, xmmword [rbx], 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xc6, 0xc3, 0x08], "shufpd xmm0, xmm3, 0x8");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd1, 0xc1], "psrlw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd1, 0x01], "psrlw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd2, 0xc1], "psrld xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd2, 0x01], "psrld xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd3, 0xc1], "psrlq xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd3, 0x01], "psrlq xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd4, 0xc1], "paddq xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd4, 0x01], "paddq xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd5, 0xc1], "pmullw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd5, 0x01], "pmullw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd6, 0xc1], "movq xmm1, xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd6, 0x01], "movq qword [rcx], xmm0");
    testcase!(invalid: &[0xf3, 0x4f, 0x0f, 0xd6, 0x03]);
    testcase!(features { SSE: true, SSE2: true } &[0xf3, 0x4f, 0x0f, 0xd6, 0xc3], "movq2dq xmm8, mm3");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x4f, 0x0f, 0xd6, 0xc3], "movdq2q mm0, xmm11");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd7, 0xc1], "pmovmskb eax, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xd7, 0xc1], "pmovmskb r8d, xmm9");
    testcase!(invalid: &[0x66, 0x0f, 0xd7, 0x01]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd8, 0xc1], "psubusb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd8, 0x01], "psubusb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd9, 0xc1], "psubusw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xd9, 0x01], "psubusw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xda, 0xc1], "pminub xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xda, 0x01], "pminub xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdb, 0xc1], "pand xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdb, 0x01], "pand xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdc, 0xc1], "paddusb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdc, 0x01], "paddusb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdd, 0xc1], "paddusw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdd, 0x01], "paddusw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xde, 0xc1], "pmaxub xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xde, 0x01], "pmaxub xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdf, 0xc1], "pandn xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xdf, 0x01], "pandn xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe0, 0xc1], "pavgb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe0, 0x01], "pavgb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe1, 0xc1], "psraw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe1, 0x01], "psraw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe2, 0xc1], "psrad xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe2, 0x01], "psrad xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe3, 0xc1], "pavgw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe3, 0x01], "pavgw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe4, 0xc1], "pmulhuw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe4, 0x01], "pmulhuw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe5, 0xc1], "pmulhw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe5, 0x01], "pmulhw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe6, 0xc1], "cvttpd2dq xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe6, 0x01], "cvttpd2dq xmm0, xmmword [rcx]");
    testcase!(invalid: &[0x66, 0x0f, 0xe7, 0xc1]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe7, 0x01], "movntdq xmmword [rcx], xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe8, 0xc1], "psubsb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe8, 0x01], "psubsb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe9, 0xc1], "psubsw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xe9, 0x01], "psubsw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xea, 0xc1], "pminsw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xea, 0x01], "pminsw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xeb, 0xc3], "por xmm0, xmm3");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xeb, 0xc4], "por xmm0, xmm4");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xeb, 0xd3], "por xmm2, xmm3");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xeb, 0x12], "por xmm2, xmmword [rdx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xeb, 0xc1], "por xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xeb, 0x01], "por xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xec, 0xc1], "paddsb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xec, 0x01], "paddsb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xed, 0xc1], "paddsw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xed, 0x01], "paddsw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xee, 0xc1], "pmaxsw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xee, 0x01], "pmaxsw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xef, 0xc1], "pxor xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xef, 0x01], "pxor xmm0, xmmword [rcx]");
    testcase!(invalid: &[0x66, 0x0f, 0xf0, 0xc1]);
    testcase!(invalid: &[0x66, 0x0f, 0xf0, 0x01]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf1, 0xc1], "psllw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf1, 0x01], "psllw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf2, 0xc1], "pslld xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf2, 0x01], "pslld xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf3, 0xc1], "psllq xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf3, 0x01], "psllq xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf4, 0xc1], "pmuludq xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf4, 0x01], "pmuludq xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf5, 0xc1], "pmaddwd xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf5, 0x01], "pmaddwd xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf6, 0xc1], "psadbw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf6, 0x01], "psadbw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf7, 0xc1], "maskmovdqu xmm0, xmm1");
    testcase!(invalid: &[0x66, 0x0f, 0xf7, 0x01]);
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf8, 0xc1], "psubb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf8, 0x01], "psubb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf9, 0xc1], "psubw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf9, 0x01], "psubw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfa, 0xc1], "psubd xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfa, 0x01], "psubd xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfb, 0xc1], "psubq xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfb, 0x01], "psubq xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfc, 0xc1], "paddb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfc, 0x01], "paddb xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfd, 0xc1], "paddw xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfd, 0x01], "paddw xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfe, 0xc1], "paddd xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xfe, 0x01], "paddd xmm0, xmmword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xff, 0xc1], "ud0 eax, ecx");
    testcase!(features { SSE: true, SSE2: true } &[0xf2, 0x0f, 0xff, 0xc1], "ud0 eax, ecx");
    testcase!(features { SSE: true, SSE2: true } &[0xf3, 0x0f, 0xff, 0xc1], "ud0 eax, ecx");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xff, 0x01], "ud0 eax, dword [rcx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x4f, 0x0f, 0xff, 0xc1], "ud0 r8d, r9d");

    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0x74, 0xc1], "pcmpeqb xmm0, xmm1");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0x74, 0x12], "pcmpeqb xmm2, xmmword [rdx]");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf8, 0xc8], "psubb xmm1, xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf8, 0xd0], "psubb xmm2, xmm0");
    testcase!(features { SSE: true, SSE2: true } &[0x66, 0x0f, 0xf8, 0x12], "psubb xmm2, xmmword [rdx]");
}
...
//    testcase!(&[0xc4, 0x63, 0x91, 0x7f, 0x2f, 0x2e], "vfnmsubsd xmm13, xmm13, xmm2, qword ptr [rdi]");
    ...
    testcase!(&[0x62, 0x42, 0xd5, 0x9d, 0x97, 0xf6], "vfmsubadd132pd zmm30{k5}{z}{rne-sae}, zmm5, zmm14");
