...
///
/// `InstDecoder::default()` constructs a decoder that will decode all instructions valid in 64-bit
...
//                visitor.visit_other()
            ...
            OperandSpec::Deref_rsi => {
//                visitor.visit_other()
                visitor.visit_deref(RegSpec::rsi())
            }
            OperandSpec::Deref_rdi => {
//                visitor.visit_other()
            ...
            OperandSpec::ImmI64 => visitor.visit_i64(self.imm as i64),
    ...
    /// use yaxpeax_x86::long_mode::display::DefaultRules;
    ///
    ...
    /// let formatted = format!("{}", DefaultRules::new(DisplayStyle::Intel).display(inst));
